...
void MixPulseAudioProcessorEditor::paint(juce::Graphics& g)
{
    ...
    auto mx=[ref](float l){return juce::jmap(l,-30.0f,-6.0f,ref.getX(),ref.getRight());}; g.setColour(theme.secondary.withAlpha(0.6f)); g.drawVerticalLine((int)mx(-14),ref.getY(),ref.getBottom()); g.drawVerticalLine((int)mx(-23),ref.getY(),ref.getBottom()); g.setColour(theme.mutedText); g.drawText("LUFS ref", (int)ref.getX(), (int)ref.getY()-12, 70, 10, juce::Justification::left);
