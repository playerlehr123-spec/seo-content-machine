...
void MixPulseAudioProcessorEditor::paint(juce::Graphics& g)
{
    ...
    auto visCtl=right.reduced(12); g.setColour(theme.grid); g.drawRoundedRectangle(visCtl.toFloat(),6,1); g.drawText("Visualizer mode: " + VisualizerRenderer::modeName(processor.visualizerState.mode.load()), visCtl.removeFromTop(22), juce::Justification::left); g.drawText("Beat Sync: " + juce::String(processor.visualizerState.beatSync.load()?"ON":"OFF"), visCtl.removeFromTop(18), juce::Justification::left); g.drawText("Theme: Dark Neon (dropdown placeholder)", visCtl.removeFromTop(18), juce::Justification::left); g.drawText("FX: Bloom Mirror Colorize Scanlines Chromatic", visCtl.removeFromTop(18), juce::Justification::left); g.drawText("Mod Source: FullAmplitude (placeholder)", visCtl.removeFromTop(18), juce::Justification::left); g.drawText("Output preset: Landscape16x9", visCtl.removeFromTop(18), juce::Justification::left); g.drawText("Export presets coming soon", visCtl.removeFromTop(18), juce::Justification::left);
}
