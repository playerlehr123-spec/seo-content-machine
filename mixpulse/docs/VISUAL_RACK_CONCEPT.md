...
Current visual engine status:
- Spectrum Bars is the primary real visual module.
- Logo Reactor is placeholder.
- Release Promo Card is placeholder.
- Meter Overlay is placeholder.
- Creator Output is intended for OBS/window capture.
- Frame export is PNG still only in current beta.
